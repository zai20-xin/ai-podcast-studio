...
SCENE_PRESETS = {
    # ── 节目格式（优先展示：最常见的两种播客形态）──
    "🎙️ 单人播客": {
        "description": "一人主讲的播客口播，像对听众说话",
        "voice_id": "冰糖",
        "speed": "正常",
        "style": "",
        "emotion": "",
        "global_instruction": (
            "你是一档单人播客的主播，正在对着麦克风和听众聊一个话题。"
            "像在跟一位老朋友说话，不要播音腔；有观点、有停顿，"
            "重点处放慢半拍，段落之间留出呼吸感。整期由你一个人讲完。"
        ),
    },
    "🎙️ 双人对谈": {
        "description": "两位主播一来一回的对话式播客",
        "voice_id": "冰糖",
        "speed": "正常",
        "style": "",
        "emotion": "",
        "global_instruction": (
            "这是一档双人对谈播客，两位主播在聊同一个话题。"
            "语气松弛自然，像朋友对谈：允许接话、轻微打断和语气词，"
            "不要各自念稿。一人抛出观点，另一人回应或追问，对话要衔接得上。"
        ),
    },
    # ── 内容气质 ──
    "📖 讲故事": {
